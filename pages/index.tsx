...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-4 pt-0 md:pt-0">
      <Head>
        <title>Home Page</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <HowToPlay isOpen={isOpen} setIsOpen={setIsOpen} />
      {
        messageState && 
      ...
      <h1 className="sm:mb-4 text-3xl font-extrabold py-4 border-b-2 shadow w-full text-center">Wordle</h1>
